...
using ZOI.DAL.Providers.UnitOfWork;

namespace ZOI_DAL.Providers.Infrastructure
{
    public class ADODataFunction : Disposable
    {
        //private readonly ZOI.BAL.DBContextZoi.DBContextZoi _dbContextZoi;
        //public ADODataFunction(ZOI.BAL.DBContextZoi.DBContextZoi dbContextZoi)
        //{
        //    _dbContextZoi = dbContextZoi;
        //}
        ...
        public List<T> ExecSQL<T>(string query)
        {
            try
            {
                ...
                ConnectionStringSSON = root.GetConnectionString("RsecConfig");
        ...
        public DataSet KYCExecuteDataset(string CommandText, SqlParameter[] SqlParameters, CommandType Type = CommandType.StoredProcedure)
        {
            try
            {
                string ConnectionStringSSON = string.Empty;
        ...
        // {
        //     return _dbContextZoi.Employees.ToList();
        // }
    }
}
